...
import {Avatar, Grid, List, ListItem, ListItemAvatar, ListItemText, ListSubheader, Typography} from "@material-ui/core";
            ...
            <ListItemAvatar>
                <StyledBadge isActive={ user.active }>
                    { user.profile_pic ? (
                        ...
                        <AvatarText text={ user.name } bg={ user.active ? "seagreen" : "tomato" } />
                    ) }
                </StyledBadge>
            </ListItemAvatar>
